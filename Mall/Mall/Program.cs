...
namespace Mall
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string parkingtollinput = Console.ReadLine();
            int parkingtoll = int.Parse(parkingtollinput);
            Console.WriteLine("Ingrese el costo de construir un metro cuadrado:");
            string precioConstruccioninput = Console.ReadLine();
            int precioConstruccion = int.Parse(precioConstruccioninput);
            Console.WriteLine("Ingrese el valor del arriendo por Metro Cuadrado:");
            string precioArriendoinput = Console.ReadLine();
            int precioArriendo = int.Parse(precioArriendoinput);
            Console.WriteLine("Ingrese la cantidad de pisos que tendra el mall");
            string pisosinput = Console.ReadLine();
            int pisos = int.Parse(pisosinput);
            int t = 1;
            while (t <= pisos)
            {
                Console.WriteLine("Indique la cantidad de Metros cuadrados mayor a 10 para el piso " + t);
                int areainput = int.Parse(Console.ReadLine());
                if (t ==1)
                {
            ...
            while (internaluse == 1)
            {
                ...
                if (selection == 1)
                {
                    ...
                    int floorint = int.Parse(floorInput);
                    ...
                    int categoryint = int.Parse(CategoryInput);
                    ...
                    string pminInput = Console.ReadLine();
                    int pmin = int.Parse(pminInput);
                    Console.WriteLine("Indique el monto maximo de compra");
                    string pmaxInput = Console.ReadLine();
                    int pmax = int.Parse(pmaxInput);


                    mall.getfloor(floorint).AgregarTienda(nameInput, area, categoryint, empint, pmin, pmax);
